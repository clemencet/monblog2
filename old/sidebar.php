				   		...
				   		<div class="padding">
				    		...
				    		<div>
				   				<a href="http://www.ljsf.fr" target="blank">
									<img src="<?php bloginfo('template_directory');?>/images/ljsf_logo.png" alt="les j3ux sont faits" class="half-wide">
								</a>
							...
							<div class="padding">
								<a href="http://www.geekgirlpenpals.com" target="blank">
									<img src="<?php bloginfo('template_directory');?>/images/iggppc_pride-glados-xs.jpg" alt="geek girl pen pals club" class="wide">
								</a>
							</div>
							<div class="padding">
							...
							<div class="padding">
								...
								<img src="<?php bloginfo('template_directory');?>/images/iggppc_manifesto.jpg" class="wide">
								</button>
								<!-- Modal -->
